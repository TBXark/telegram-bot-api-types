...
export type MessageEntityType = 'mention' | 'hashtag' | 'cashtag' | 'bot_command' | 'url' | 'email' | 'phone_number' | 'bold' | 'italic' | 'underline' | 'strikethrough' | 'spoiler' | 'blockquote' | 'expandable_blockquote' | 'code' | 'pre' | 'text_link' | 'text_mention' | 'custom_emoji';
...
export interface SuggestedPostPaid {
    /** Message | Optional. Message containing the suggested post. Note that the Message object in this field will not contain the reply_to_message field even if it itself is a reply. */
    suggested_post_message?: Message;
    /** String | Currency in which the payment was made. Currently, one of "XTR" for Telegram Stars or "TON" for Grams */
    currency: string;
    /** Integer | Optional. The amount of the currency that was received by the channel in nanograms; for payments in Grams only */
    amount?: number;
...
export interface SuggestedPostPrice {
    /** String | Currency in which the post will be paid. Currently, must be one of "XTR" for Telegram Stars or "TON" for Grams */
    currency: string;
...
export interface UniqueGiftInfo {
    ...
    origin: string;
    /** String | Optional. For gifts bought from other users, the currency in which the payment for the gift was done. Currently, one of "XTR" for Telegram Stars or "TON" for Grams. */
