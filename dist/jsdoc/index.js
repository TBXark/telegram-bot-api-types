 ...
 * @property {boolean} [can_manage_tags] - Optional. True, if the administrator can edit the tags of regular members; for groups and supergroups only. If omitted defaults to the value of can_pin_messages.
 */
 ...
 * @property {boolean} [can_edit_tag] - Optional. True, if the user is allowed to edit their own tag
