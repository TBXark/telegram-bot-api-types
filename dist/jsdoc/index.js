 ...
 * - PaidMediaPhoto
 * - PaidMediaVideo
 * @typedef {PaidMediaPreview | PaidMediaPhoto | PaidMediaVideo} PaidMedia
 */
 ...
 * - InputPaidMediaPhoto
 * - InputPaidMediaVideo
 * @typedef {InputPaidMediaPhoto | InputPaidMediaVideo} InputPaidMedia
 */
 ...
 * @property {number} [total_count] - Optional. The total number of the gifts of this type that can be sent; for limited gifts only
 * @property {number} [remaining_count] - Optional. The number of remaining gifts of this type that can be sent; for limited gifts only
 */
 ...
 * @typedef {TransactionPartnerUser | TransactionPartnerFragment | TransactionPartnerTelegramAds | TransactionPartnerTelegramApi | TransactionPartnerOther} TransactionPartner
 */
 ...
 * @property {number} [subscription_period] - Optional. The duration of the paid subscription
 ...
 * @property {number | string} chat_id - Unique identifier for the target chat or username of the target channel (in the format @channelusername)
 * @property {number} [message_thread_id] - Unique identifier for the target message thread (topic) of the forum; for forum supergroups only
 * @property {Array<InputMediaAudio> | Array<InputMediaDocument> | Array<InputMediaPhoto> | Array<InputMediaVideo>} media - A JSON-serialized array describing messages to be sent, must include 2-10 items
 ...
 * @property {string} [text] - Text that will be shown along with the gift; 0-255 characters
 ...
 * @property {Array<MessageEntity>} [text_entities] - A JSON-serialized list of special entities that appear in the gift text. It can be specified instead of text_parse_mode. Entities other than "bold", "italic", "underline", "strikethrough", "spoiler", and "custom_emoji" are ignored.
 */
