 ...
 * @property {Message} [suggested_post_message] - Optional. Message containing the suggested post. Note that the Message object in this field will not contain the reply_to_message field even if it itself is a reply.
 * @property {string} currency - Currency in which the payment was made. Currently, one of "XTR" for Telegram Stars or "TON" for Grams
 * @property {number} [amount] - Optional. The amount of the currency that was received by the channel in nanograms; for payments in Grams only
 ...
 * @property {string} currency - Currency in which the post will be paid. Currently, must be one of "XTR" for Telegram Stars or "TON" for Grams
 ...
 * @property {string} [last_resale_currency] - Optional. For gifts bought from other users, the currency in which the payment for the gift was done. Currently, one of "XTR" for Telegram Stars or "TON" for Grams.
 ...
 * @property {User} [new_owner] - Optional. The user which will be the new owner of the chat if the previous owner does not return to the chat
 */
