...
extension TelegramAPI {
    ...
    */
    public class User: Codable {
        ...
        public init(id: Int, is_bot: Bool, first_name: String, last_name: String? = nil, username: String? = nil, language_code: String? = nil, is_premium: Bool? = nil, added_to_attachment_menu: Bool? = nil, can_join_groups: Bool? = nil, can_read_all_group_messages: Bool? = nil, supports_inline_queries: Bool? = nil, can_connect_to_business: Bool? = nil, has_main_web_app: Bool? = nil, has_topics_enabled: Bool? = nil, allows_users_to_create_topics: Bool? = nil) {
            self.id = id
            self.is_bot = is_bot
...
extension TelegramAPI {
    ...
    */
    public class KeyboardButton: Codable {
        ...
        public init(text: String, icon_custom_emoji_id: String? = nil, style: String? = nil, request_users: KeyboardButtonRequestUsers? = nil, request_chat: KeyboardButtonRequestChat? = nil, request_contact: Bool? = nil, request_location: Bool? = nil, request_poll: KeyboardButtonPollType? = nil, web_app: WebAppInfo? = nil) {
            self.text = text
            self.icon_custom_emoji_id = icon_custom_emoji_id
            self.style = style
