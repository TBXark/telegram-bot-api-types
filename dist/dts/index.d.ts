...
export interface InputRichMessage {
    ...
    markdown?: string;
    /** Array of InputRichMessageMedia | Optional. List of media that are specified in the markdown or html fields using tg://photo?id=, tg://video?id=, and tg://audio?id= links */
...
export interface InputRichMessageMedia {
    /** String | Unique identifier of the media used in a tg://photo?id=, tg://video?id=, or tg://audio?id= link. 1-64 characters, only A-Z, a-z, 0-9, _ and - are allowed. */
    id: string;
    /** InputMediaAnimation or InputMediaAudio or InputMediaPhoto or InputMediaVideo or InputMediaVoiceNote | The media to be sent. Everything except the media itself and its properties is ignored. */
...
export interface InputRichBlockMap {
    ...
    /** Location | Location of the center of the map */
    location: Location;
    /** Integer | Map zoom level; 0-24 */
    zoom: number;
    /** Integer | Map width; 0-10000 */
    width: number;
    /** Integer | Map height; 0-10000 */
    height: number;
    /** RichBlockCaption | Optional. Caption of the block */
    caption?: RichBlockCaption;
}
...
export interface EditMessageTextParams {
    ...
    /** LinkPreviewOptions | Link preview generation options for the message */
    link_preview_options?: LinkPreviewOptions;
    /** InputRichMessage | New rich content of the message; required if text isn't specified. Direct upload of new files isn't supported when an inline message is edited. */
    rich_message?: InputRichMessage;
    /** InlineKeyboardMarkup | A JSON-serialized object for an inline keyboard */
    reply_markup?: InlineKeyboardMarkup;
}
...
export interface EditEphemeralMessageTextParams {
    ...
    ephemeral_message_id: number;
    /** String | New text of the message, 1-4096 characters after entity parsing */
    text: string;
    /** String | Mode for parsing entities in the message text. See formatting options for more details. */
    parse_mode?: string;
    /** Array of MessageEntity | A JSON-serialized list of special entities that appear in message text, which can be specified instead of parse_mode */
...
export interface EditEphemeralMessageMediaParams {
    ...
    /** Integer | Identifier of the ephemeral message to edit */
    ephemeral_message_id: number;
    /** InputMedia | A JSON-serialized object for the new media content of the message. A new file can't be uploaded; use a previously uploaded file via its file_id or specify a URL. */
    media: InputMedia;
    /** InlineKeyboardMarkup | A JSON-serialized object for an inline keyboard */
    reply_markup?: InlineKeyboardMarkup;
}
...
export interface SendRichMessageDraftParams {
    ...
    /** Integer | Unique identifier of the message draft; must be non-zero. Changes to drafts with the same identifier are animated. */
    draft_id: number;
    /** InputRichMessage | The partial message to be streamed. Direct upload of new files isn't supported. */
    rich_message: InputRichMessage;
}
