 ...
 * @property {number | string} [chat_id] - Optional. If the message to be replied to is from a different chat, unique identifier for the chat or username of the channel (in the format @channelusername). Not supported for messages sent on behalf of a business account and messages from channel direct messages chats.
 ...
 * @property {User} [completed_by_user] - Optional. User that completed the task; omitted if the task wasn't completed
 ...
 * @property {Array<MessageEntity>} [text_entities] - Optional. List of special entities that appear in the text, which can be specified instead of parse_mode. Currently, only bold, italic, underline, strikethrough, spoiler, and custom_emoji entities are allowed.
 */
 ...
 * @property {Array<MessageEntity>} [title_entities] - Optional. List of special entities that appear in the title, which can be specified instead of parse_mode. Currently, only bold, italic, underline, strikethrough, spoiler, and custom_emoji entities are allowed.
 ...
 * @property {number} topic_id - Unique identifier of the topic
 ...
 * @property {number} [prepaid_upgrade_star_count] - Optional. Number of Telegram Stars that were prepaid by the sender for the ability to upgrade the gift
 ...
 * @property {number} [last_resale_star_count] - Optional. For gifts bought from other users, the price paid for the gift
 * @property {string} [owned_gift_id] - Optional. Unique identifier of the received gift for the bot; only present for gifts received on behalf of business accounts
 ...
 * @property {number} [convert_star_count] - Optional. Number of Telegram Stars that can be claimed by the receiver instead of the gift; omitted if the gift cannot be converted to Telegram Stars
 * @property {number} [prepaid_upgrade_star_count] - Optional. Number of Telegram Stars that were paid by the sender for the ability to upgrade the gift
 */
 ...
 * @property {number | string} chat_id - Unique identifier for the target chat or username of the target supergroup (in the format @supergroupusername). Channel direct messages chats and channel chats aren't supported.
 */
 ...
 * @property {number} [message_thread_id] - Unique identifier for the target message thread (topic) of the forum; for forum supergroups only
 * @property {number} [direct_messages_topic_id] - Identifier of the direct messages topic to which the message will be sent; required if the message is sent to a direct messages chat
 * @property {number} star_count - The number of Telegram Stars that must be paid to buy access to the media; 1-10000
 ...
 * @property {string} [business_connection_id] - Unique identifier of the business connection on behalf of which the message will be sent
 * @property {number | string} chat_id - Unique identifier for the target chat or username of the target channel (in the format @channelusername). Polls can't be sent to channel direct messages chats.
 * @property {number} [message_thread_id] - Unique identifier for the target message thread (topic) of the forum; for forum supergroups only
 * @property {string} question - Poll question, 1-300 characters
 ...
 * @property {Array<InputPollOption>} options - A JSON-serialized list of 2-12 answer options
 ...
 * @property {number | string} chat_id - Unique identifier for the target chat or username of the target supergroup (in the format @supergroupusername). Channel chats and channel direct messages chats aren't supported.
 ...
 * @property {number | string} chat_id - Unique identifier for the target chat or username of the target supergroup or channel (in the format @channelusername). Channel direct messages chats aren't supported; leave the corresponding channel instead.
 */
 ...
 * @property {number | string} [chat_id] - Required if user_id is not specified. Unique identifier for the chat or username of the channel (in the format @channelusername) that will receive the gift.
 ...
 * @property {number | string} chat_id - Unique identifier for the target chat or username of the target channel (in the format @channelusername). Channel direct messages chats can't be verified.
 * @property {string} [custom_description] - Custom description for the verification; 0-70 characters. Must be empty if the organization isn't allowed to provide a custom verification description.
 */
 ...
 * @property {boolean} [exclude_limited] - Pass True to exclude gifts that can be purchased a limited number of times
 ...
 * @property {string} [business_connection_id] - Unique identifier of the business connection on behalf of which the message will be sent
 * @property {number} chat_id - Unique identifier for the target chat. Games can't be sent to channel direct messages chats and channel chats.
 * @property {number} [message_thread_id] - Unique identifier for the target message thread (topic) of the forum; for forum supergroups only
