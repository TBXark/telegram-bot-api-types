 ...
 * @property {Array<InputRichMessageMedia>} [media] - Optional. List of media that are specified in the markdown or html fields using tg://photo?id=, tg://video?id=, and tg://audio?id= links
 ...
 * @property {'map'} type - Type of the block, always "map"
 * @property {Location} location - Location of the center of the map
 * @property {number} zoom - Map zoom level; 0-24
 * @property {number} width - Map width; 0-10000
 * @property {number} height - Map height; 0-10000
 * @property {RichBlockCaption} [caption] - Optional. Caption of the block
 */
 ...
 * @property {number} receiver_user_id - Identifier of the user who received the message
 * @property {number} ephemeral_message_id - Identifier of the ephemeral message to edit
 * @property {InputMedia} media - A JSON-serialized object for the new media content of the message. A new file can't be uploaded; use a previously uploaded file via its file_id or specify a URL.
 * @property {InlineKeyboardMarkup} [reply_markup] - A JSON-serialized object for an inline keyboard
 */
