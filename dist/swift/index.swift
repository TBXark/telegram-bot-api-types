...
extension TelegramAPI {
    ...
    */
    public class User: Codable {
        ...
        public let supports_join_request_queries: Bool?

        public init(id: Int, is_bot: Bool, first_name: String, last_name: String? = nil, username: String? = nil, language_code: String? = nil, is_premium: Bool? = nil, added_to_attachment_menu: Bool? = nil, can_join_groups: Bool? = nil, can_read_all_group_messages: Bool? = nil, supports_guest_queries: Bool? = nil, supports_inline_queries: Bool? = nil, can_connect_to_business: Bool? = nil, has_main_web_app: Bool? = nil, has_topics_enabled: Bool? = nil, allows_users_to_create_topics: Bool? = nil, can_manage_bots: Bool? = nil, supports_join_request_queries: Bool? = nil) {
            self.id = id
            self.is_bot = is_bot
...
extension TelegramAPI {
    ...
    */
    public class Message: Codable {
        ...
        public let rich_message: RichMessage?
...
extension TelegramAPI {
    ...
    */
    public class PollMedia: Codable {
        ...
        public init(animation: Animation? = nil, audio: Audio? = nil, document: Document? = nil, link: Link? = nil, live_photo: LivePhoto? = nil, location: Location? = nil, photo: Array<PhotoSize>? = nil, sticker: Sticker? = nil, venue: Venue? = nil, video: Video? = nil) {
            self.animation = animation
            self.audio = audio
            self.document = document
            self.link = link
...
extension TelegramAPI {
    ...
    */
    public indirect enum InputPollOptionMedia: Codable {
        case inputMediaAnimation(InputMediaAnimation)
        case inputMediaLink(InputMediaLink)
        case inputMediaLivePhoto(InputMediaLivePhoto)
        case inputMediaLocation(InputMediaLocation)
        case inputMediaPhoto(InputMediaPhoto)
        ...
        public init(from decoder: Decoder) throws {
            ...
            else if let value = try? container.decode(InputMediaLink.self) {
...
extension TelegramAPI {
    ...
    */
    public class RichMessage: Codable {
        /** Array of RichBlock | Content of the message */
        public let blocks: Array<RichBlock>
        /** Boolean | Optional. True, if the rich message must be shown right-to-left */
        public let is_rtl: Bool?

        public init(blocks: Array<RichBlock>, is_rtl: Bool? = nil) {
            self.blocks = blocks
            self.is_rtl = is_rtl
        }
    }
...
extension TelegramAPI {
    ...
    */
    public class InputRichMessage: Codable {
        /** String | Optional. Content of the rich message to send described using HTML formatting. See rich message formatting options for more details. */
        public let html: String?
        /** String | Optional. Content of the rich message to send described using Markdown formatting. See rich message formatting options for more details. */
        ...
        public let skip_entity_detection: Bool?

        public init(html: String? = nil, markdown: String? = nil, is_rtl: Bool? = nil, skip_entity_detection: Bool? = nil) {
            self.html = html
...
extension TelegramAPI {
    ...
    */
    public indirect enum RichText: Codable {
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.singleValueContainer()
            if let value = try? container.decode(RichTextBold.self) {
                self = .richTextBold(value)
            }
            else if let value = try? container.decode(RichTextItalic.self) {
                self = .richTextItalic(value)
            }
            else if let value = try? container.decode(RichTextUnderline.self) {
                self = .richTextUnderline(value)
            }
            else if let value = try? container.decode(RichTextStrikethrough.self) {
                self = .richTextStrikethrough(value)
            }
            else if let value = try? container.decode(RichTextSpoiler.self) {
                self = .richTextSpoiler(value)
            }
            else if let value = try? container.decode(RichTextDateTime.self) {
                self = .richTextDateTime(value)
            }
            else if let value = try? container.decode(RichTextTextMention.self) {
                self = .richTextTextMention(value)
            }
            else if let value = try? container.decode(RichTextSubscript.self) {
                self = .richTextSubscript(value)
            }
            else if let value = try? container.decode(RichTextSuperscript.self) {
                self = .richTextSuperscript(value)
            }
            else if let value = try? container.decode(RichTextMarked.self) {
                self = .richTextMarked(value)
            }
            else if let value = try? container.decode(RichTextCode.self) {
                self = .richTextCode(value)
            }
            else if let value = try? container.decode(RichTextCustomEmoji.self) {
                self = .richTextCustomEmoji(value)
            }
            else if let value = try? container.decode(RichTextMathematicalExpression.self) {
                self = .richTextMathematicalExpression(value)
            }
            else if let value = try? container.decode(RichTextUrl.self) {
                self = .richTextUrl(value)
            }
            else if let value = try? container.decode(RichTextEmailAddress.self) {
                self = .richTextEmailAddress(value)
            }
            else if let value = try? container.decode(RichTextPhoneNumber.self) {
                self = .richTextPhoneNumber(value)
            }
            else if let value = try? container.decode(RichTextBankCardNumber.self) {
                self = .richTextBankCardNumber(value)
            }
            else if let value = try? container.decode(RichTextMention.self) {
                self = .richTextMention(value)
            }
            else if let value = try? container.decode(RichTextHashtag.self) {
                self = .richTextHashtag(value)
            }
            else if let value = try? container.decode(RichTextCashtag.self) {
                self = .richTextCashtag(value)
            }
            else if let value = try? container.decode(RichTextBotCommand.self) {
                self = .richTextBotCommand(value)
            }
            else if let value = try? container.decode(RichTextAnchor.self) {
                self = .richTextAnchor(value)
            }
            else if let value = try? container.decode(RichTextAnchorLink.self) {
                self = .richTextAnchorLink(value)
            }
            else if let value = try? container.decode(RichTextReference.self) {
                self = .richTextReference(value)
            }
            else if let value = try? container.decode(RichTextReferenceLink.self) {
                self = .richTextReferenceLink(value)
            }else {
                throw DecodingError.typeMismatch(RichText.self, DecodingError.Context(codingPath: decoder.codingPath, debugDescription: "Wrong type for RichText"))
            }
        }
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            switch self {
                ...
                case .richTextDateTime(let value):
                    try container.encode(value)
                case .richTextTextMention(let value):
                    try container.encode(value)
...
extension TelegramAPI {
     ...
     * A bold text.
    */
    public class RichTextBold: Codable {
        /** String | Type of the rich text, always "bold" */
        public let type: String
        /** RichText | The text */
        public let text: RichText

        public init(type: String, text: RichText) {
            self.type = type
            self.text = text
        }
    }
...
extension TelegramAPI {
     ...
     * An italicized text.
    */
    public class RichTextItalic: Codable {
...
extension TelegramAPI {
     ...
     * An underlined text.
    */
    public class RichTextUnderline: Codable {
...
extension TelegramAPI {
    ...
    */
    public class RichTextStrikethrough: Codable {
...
extension TelegramAPI {
    ...
    */
    public class RichTextSpoiler: Codable {
...
extension TelegramAPI {
    ...
    */
    public class RichTextDateTime: Codable {
        ...
        public init(type: String, text: RichText, unix_time: Int, date_time_format: String) {
            self.type = type
            self.text = text
            self.unix_time = unix_time
            self.date_time_format = date_time_format
...
extension TelegramAPI {
    ...
    */
    public class RichTextTextMention: Codable {
        ...
        public init(type: String, text: RichText, user: User) {
            self.type = type
            self.text = text
            self.user = user
        }
...
extension TelegramAPI {
     ...
     * A subscript text.
    */
    public class RichTextSubscript: Codable {
...
extension TelegramAPI {
     ...
     * A superscript text.
    */
    public class RichTextSuperscript: Codable {
...
extension TelegramAPI {
     ...
     * A marked text.
    */
    public class RichTextMarked: Codable {
...
extension TelegramAPI {
     ...
     * A monowidth text.
    */
    public class RichTextCode: Codable {
...
extension TelegramAPI {
     ...
     * A custom emoji.
    */
    public class RichTextCustomEmoji: Codable {
        ...
        public let alternative_text: String

        public init(type: String, custom_emoji_id: String, alternative_text: String) {
            self.type = type
            self.custom_emoji_id = custom_emoji_id
...
extension TelegramAPI {
     ...
     * A text with a link.
    */
    public class RichTextUrl: Codable {
        ...
        public init(type: String, text: RichText, url: String) {
            self.type = type
            self.text = text
            self.url = url
        }
...
extension TelegramAPI {
    ...
    */
    public class RichTextEmailAddress: Codable {
        ...
        public init(type: String, text: RichText, email_address: String) {
            self.type = type
            self.text = text
...
extension TelegramAPI {
    ...
    */
    public class RichTextPhoneNumber: Codable {
        ...
        public init(type: String, text: RichText, phone_number: String) {
            self.type = type
            self.text = text
            self.phone_number = phone_number
        }
...
extension TelegramAPI {
    ...
    */
    public class RichTextBankCardNumber: Codable {
        /** String | Type of the rich text, always "bank_card_number" */
        public let type: String
        /** RichText | The text */
        public let text: RichText
        /** String | The bank card number */
        public let bank_card_number: String

        public init(type: String, text: RichText, bank_card_number: String) {
            self.type = type
            self.text = text
...
extension TelegramAPI {
    ...
    */
    public class RichTextMention: Codable {
        ...
        public init(type: String, text: RichText, username: String) {
            self.type = type
            self.text = text
            self.username = username
        }
...
extension TelegramAPI {
     ...
     * A hashtag.
    */
    public class RichTextHashtag: Codable {
        ...
        public init(type: String, text: RichText, hashtag: String) {
            self.type = type
            self.text = text
...
extension TelegramAPI {
     ...
     * A cashtag.
    */
    public class RichTextCashtag: Codable {
        ...
        public init(type: String, text: RichText, cashtag: String) {
            self.type = type
            self.text = text
...
extension TelegramAPI {
     ...
     * A bot command.
    */
    public class RichTextBotCommand: Codable {
        /** String | Type of the rich text, always "bot_command" */
        public let type: String
        /** RichText | The text */
        public let text: RichText
        /** String | The bot command */
        public let bot_command: String

        public init(type: String, text: RichText, bot_command: String) {
            self.type = type
            self.text = text
...
extension TelegramAPI {
     ...
     * An anchor.
    */
    public class RichTextAnchor: Codable {
...
extension TelegramAPI {
     ...
     * A link to an anchor.
    */
    public class RichTextAnchorLink: Codable {
        ...
        public let anchor_name: String

        public init(type: String, text: RichText, anchor_name: String) {
            self.type = type
            self.text = text
...
extension TelegramAPI {
     ...
     * A reference.
    */
    public class RichTextReference: Codable {
        ...
        public init(type: String, text: RichText, name: String) {
            self.type = type
            self.text = text
            self.name = name
        }
...
extension TelegramAPI {
    ...
    */
    public class RichTextReferenceLink: Codable {
        /** String | Type of the rich text, always "reference_link" */
        public let type: String
        /** RichText | The link text */
        public let text: RichText
        /** String | The name of the reference */
        public let reference_name: String

        public init(type: String, text: RichText, reference_name: String) {
            self.type = type
            self.text = text
...
extension TelegramAPI {
     ...
     * Cell in a table.
    */
    public class RichBlockTableCell: Codable {
        ...
        public init(text: RichText? = nil, is_header: Bool? = nil, colspan: Int? = nil, rowspan: Int? = nil, align: String, valign: String) {
            self.text = text
...
extension TelegramAPI {
    ...
    */
    public class RichBlockListItem: Codable {
        ...
        public init(label: String, blocks: Array<RichBlock>, has_checkbox: Bool? = nil, is_checked: Bool? = nil, value: Int? = nil, type: String? = nil) {
            self.label = label
            self.blocks = blocks
...
extension TelegramAPI {
     ...
     * - RichBlockThinking
    */
    public indirect enum RichBlock: Codable {
        case richBlockParagraph(RichBlockParagraph)
        case richBlockSectionHeading(RichBlockSectionHeading)
        case richBlockPreformatted(RichBlockPreformatted)
        case richBlockFooter(RichBlockFooter)
        case richBlockDivider(RichBlockDivider)
        case richBlockMathematicalExpression(RichBlockMathematicalExpression)
        case richBlockAnchor(RichBlockAnchor)
        case richBlockList(RichBlockList)
        case richBlockBlockQuotation(RichBlockBlockQuotation)
        case richBlockPullQuotation(RichBlockPullQuotation)
        case richBlockCollage(RichBlockCollage)
        case richBlockSlideshow(RichBlockSlideshow)
        case richBlockTable(RichBlockTable)
        case richBlockDetails(RichBlockDetails)
        case richBlockMap(RichBlockMap)
        case richBlockAnimation(RichBlockAnimation)
        case richBlockAudio(RichBlockAudio)
        case richBlockPhoto(RichBlockPhoto)
        case richBlockVideo(RichBlockVideo)
        case richBlockVoiceNote(RichBlockVoiceNote)
        case richBlockThinking(RichBlockThinking)

        public init(from decoder: Decoder) throws {
            let container = try decoder.singleValueContainer()
            if let value = try? container.decode(RichBlockParagraph.self) {
                self = .richBlockParagraph(value)
            }
            else if let value = try? container.decode(RichBlockSectionHeading.self) {
                self = .richBlockSectionHeading(value)
            }
            else if let value = try? container.decode(RichBlockPreformatted.self) {
                self = .richBlockPreformatted(value)
            }
            else if let value = try? container.decode(RichBlockFooter.self) {
                self = .richBlockFooter(value)
            }
            else if let value = try? container.decode(RichBlockDivider.self) {
                self = .richBlockDivider(value)
            }
            else if let value = try? container.decode(RichBlockMathematicalExpression.self) {
                self = .richBlockMathematicalExpression(value)
            }
            else if let value = try? container.decode(RichBlockAnchor.self) {
                self = .richBlockAnchor(value)
            }
            else if let value = try? container.decode(RichBlockList.self) {
                self = .richBlockList(value)
            }
            else if let value = try? container.decode(RichBlockBlockQuotation.self) {
                self = .richBlockBlockQuotation(value)
            }
            else if let value = try? container.decode(RichBlockPullQuotation.self) {
                self = .richBlockPullQuotation(value)
            }
            else if let value = try? container.decode(RichBlockCollage.self) {
                self = .richBlockCollage(value)
            }
            else if let value = try? container.decode(RichBlockSlideshow.self) {
                self = .richBlockSlideshow(value)
            }
            else if let value = try? container.decode(RichBlockTable.self) {
                self = .richBlockTable(value)
            }
            else if let value = try? container.decode(RichBlockDetails.self) {
                self = .richBlockDetails(value)
            }
            else if let value = try? container.decode(RichBlockMap.self) {
                self = .richBlockMap(value)
            }
            else if let value = try? container.decode(RichBlockAnimation.self) {
                self = .richBlockAnimation(value)
            }
            else if let value = try? container.decode(RichBlockAudio.self) {
                self = .richBlockAudio(value)
            }
            else if let value = try? container.decode(RichBlockPhoto.self) {
                self = .richBlockPhoto(value)
            }
            else if let value = try? container.decode(RichBlockVideo.self) {
                self = .richBlockVideo(value)
            }
            else if let value = try? container.decode(RichBlockVoiceNote.self) {
                self = .richBlockVoiceNote(value)
            }
            else if let value = try? container.decode(RichBlockThinking.self) {
                self = .richBlockThinking(value)
            }else {
                throw DecodingError.typeMismatch(RichBlock.self, DecodingError.Context(codingPath: decoder.codingPath, debugDescription: "Wrong type for RichBlock"))
            }
        }
        ...
        public func encode(to encoder: Encoder) throws {
            var container = encoder.singleValueContainer()
            switch self {
                case .richBlockParagraph(let value):
                    try container.encode(value)
                case .richBlockSectionHeading(let value):
                    try container.encode(value)
                case .richBlockPreformatted(let value):
                    try container.encode(value)
                case .richBlockFooter(let value):
                    try container.encode(value)
                case .richBlockDivider(let value):
                    try container.encode(value)
                case .richBlockMathematicalExpression(let value):
                    try container.encode(value)
                case .richBlockAnchor(let value):
                    try container.encode(value)
                case .richBlockList(let value):
                    try container.encode(value)
                case .richBlockBlockQuotation(let value):
                    try container.encode(value)
                case .richBlockPullQuotation(let value):
                    try container.encode(value)
                case .richBlockCollage(let value):
                    try container.encode(value)
                case .richBlockSlideshow(let value):
                    try container.encode(value)
                case .richBlockTable(let value):
                    try container.encode(value)
                case .richBlockDetails(let value):
                    try container.encode(value)
                case .richBlockMap(let value):
                    try container.encode(value)
                case .richBlockAnimation(let value):
                    try container.encode(value)
                case .richBlockAudio(let value):
                    try container.encode(value)
                case .richBlockPhoto(let value):
                    try container.encode(value)
                case .richBlockVideo(let value):
                    try container.encode(value)
                case .richBlockVoiceNote(let value):
                    try container.encode(value)
                case .richBlockThinking(let value):
                    try container.encode(value)
            }
        }
    }
...
extension TelegramAPI {
    ...
    */
    public class RichBlockParagraph: Codable {
...
extension TelegramAPI {
    ...
    */
    public class RichBlockSectionHeading: Codable {
        ...
        public init(type: String, text: RichText, size: Int) {
            self.type = type
            self.text = text
            self.size = size
        }
...
extension TelegramAPI {
    ...
    */
    public class RichBlockPreformatted: Codable {
        ...
        public init(type: String, text: RichText, language: String? = nil) {
            self.type = type
            self.text = text
            self.language = language
        }
...
extension TelegramAPI {
    ...
    */
    public class RichBlockFooter: Codable {
...
extension TelegramAPI {
    ...
    */
    public class RichBlockDivider: Codable {
...
extension TelegramAPI {
    ...
    */
    public class RichBlockMathematicalExpression: Codable {
...
extension TelegramAPI {
    ...
    */
    public class RichBlockAnchor: Codable {
...
extension TelegramAPI {
    ...
    */
    public class RichBlockList: Codable {
        /** String | Type of the block, always "list" */
        public let type: String
        /** Array of RichBlockListItem | Items of the list */
        public let items: Array<RichBlockListItem>

        public init(type: String, items: Array<RichBlockListItem>) {
            self.type = type
            self.items = items
        }
    }
...
extension TelegramAPI {
    ...
    */
    public class RichBlockBlockQuotation: Codable {
        ...
        public init(type: String, blocks: Array<RichBlock>, credit: RichText? = nil) {
            self.type = type
            self.blocks = blocks
            self.credit = credit
        }
...
extension TelegramAPI {
    ...
    */
    public class RichBlockPullQuotation: Codable {
        ...
        public init(type: String, text: RichText, credit: RichText? = nil) {
            self.type = type
            self.text = text
            self.credit = credit
        }
...
extension TelegramAPI {
    ...
    */
    public class RichBlockCollage: Codable {
        ...
        public let caption: RichBlockCaption?

        public init(type: String, blocks: Array<RichBlock>, caption: RichBlockCaption? = nil) {
            self.type = type
            self.blocks = blocks
            self.caption = caption
        }
...
extension TelegramAPI {
    ...
    */
    public class RichBlockSlideshow: Codable {
...
extension TelegramAPI {
    ...
    */
    public class RichBlockTable: Codable {
        /** String | Type of the block, always "table" */
        public let type: String
        /** Array of Array of RichBlockTableCell | Cells of the table */
        public let cells: Array<Array<RichBlockTableCell>>
        /** Boolean | Optional. True, if the table has borders */
        public let is_bordered: Bool?
        /** Boolean | Optional. True, if the table is striped */
        public let is_striped: Bool?
        /** RichText | Optional. Caption of the table */
        public let caption: RichText?

        public init(type: String, cells: Array<Array<RichBlockTableCell>>, is_bordered: Bool? = nil, is_striped: Bool? = nil, caption: RichText? = nil) {
            self.type = type
            self.cells = cells
...
extension TelegramAPI {
    ...
    */
    public class RichBlockDetails: Codable {
        ...
        public init(type: String, summary: RichText, blocks: Array<RichBlock>, is_open: Bool? = nil) {
            self.type = type
...
extension TelegramAPI {
    ...
    */
    public class RichBlockMap: Codable {
        ...
        public init(type: String, location: Location, zoom: Int, width: Int, height: Int, caption: RichBlockCaption? = nil) {
            self.type = type
            self.location = location
            self.zoom = zoom
            self.width = width
...
extension TelegramAPI {
    ...
    */
    public class RichBlockAnimation: Codable {
        ...
        public init(type: String, animation: Animation, has_spoiler: Bool? = nil, caption: RichBlockCaption? = nil) {
            self.type = type
            self.animation = animation
            self.has_spoiler = has_spoiler
            self.caption = caption
...
extension TelegramAPI {
    ...
    */
    public class RichBlockAudio: Codable {
        ...
        public init(type: String, audio: Audio, caption: RichBlockCaption? = nil) {
            self.type = type
            self.audio = audio
            self.caption = caption
        }
...
extension TelegramAPI {
    ...
    */
    public class RichBlockPhoto: Codable {
        ...
        public init(type: String, photo: Array<PhotoSize>, has_spoiler: Bool? = nil, caption: RichBlockCaption? = nil) {
            self.type = type
            self.photo = photo
            self.has_spoiler = has_spoiler
            self.caption = caption
...
extension TelegramAPI {
    ...
    */
    public class RichBlockVideo: Codable {
        ...
        public init(type: String, video: Video, has_spoiler: Bool? = nil, caption: RichBlockCaption? = nil) {
            self.type = type
            self.video = video
            self.has_spoiler = has_spoiler
            self.caption = caption
...
extension TelegramAPI {
    ...
    */
    public class RichBlockVoiceNote: Codable {
        /** String | Type of the block, always "voice_note" */
        public let type: String
        /** Voice | The voice note */
        public let voice_note: Voice
        /** RichBlockCaption | Optional. Caption of the block */
        public let caption: RichBlockCaption?

        public init(type: String, voice_note: Voice, caption: RichBlockCaption? = nil) {
            self.type = type
...
extension TelegramAPI {
    ...
    */
    public class RichBlockThinking: Codable {
        /** String | Type of the block, always "thinking" */
        public let type: String
        /** RichText | Text of the block. See https://t.me/addemoji/AIActions for examples of custom emoji, which are recommended for usage in the block. */
        public let text: RichText
...
extension TelegramAPI {
    ...
    */
    public indirect enum InputMessageContent: Codable {
        ...
        case inputRichMessageContent(InputRichMessageContent)
        ...
        public init(from decoder: Decoder) throws {
            ...
            else if let value = try? container.decode(InputRichMessageContent.self) {
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            switch self {
                case .inputTextMessageContent(let value):
                    try container.encode(value)
                case .inputRichMessageContent(let value):
                    try container.encode(value)
...
extension TelegramAPI {
    ...
    */
    public class InputRichMessageContent: Codable {
        /** InputRichMessage | The message to be sent */
        public let rich_message: InputRichMessage

        public init(rich_message: InputRichMessage) {
            self.rich_message = rich_message
        }
    }
}
...
extension TelegramAPI {
    ...
    public struct AnswerChatJoinRequestQueryParams: Codable {
        /** String | Unique identifier of the join request query */
        public let chat_join_request_query_id: String
        ...
        public init(chat_join_request_query_id: String, result: String) {
...
extension TelegramAPI {
    ...
    public typealias AnswerChatJoinRequestQueryResponse = ResponseSuccess<Bool>
...
extension TelegramAPI {
    ...
    public struct SendChatJoinRequestWebAppParams: Codable {
        /** String | Unique identifier of the join request query */
        public let chat_join_request_query_id: String
        /** String | The URL of the Mini App to be opened */
        public let web_app_url: String
        
        public init(chat_join_request_query_id: String, web_app_url: String) {
            self.chat_join_request_query_id = chat_join_request_query_id
...
extension TelegramAPI {
    ...
    public typealias SendChatJoinRequestWebAppResponse = ResponseSuccess<Bool>
...
extension TelegramAPI {
    ...
    public struct EditMessageTextParams: Codable {
        ...
        public init(business_connection_id: String? = nil, chat_id: Either2<Int, String>? = nil, message_id: Int? = nil, inline_message_id: String? = nil, text: String? = nil, parse_mode: String? = nil, entities: Array<MessageEntity>? = nil, link_preview_options: LinkPreviewOptions? = nil, rich_message: InputRichMessage? = nil, reply_markup: InlineKeyboardMarkup? = nil) {
            self.business_connection_id = business_connection_id
            self.chat_id = chat_id
            self.message_id = message_id
            self.inline_message_id = inline_message_id
...
extension TelegramAPI {
    ...
    public struct SendRichMessageParams: Codable {
        ...
        public init(business_connection_id: String? = nil, chat_id: Either2<Int, String>, message_thread_id: Int? = nil, direct_messages_topic_id: Int? = nil, rich_message: InputRichMessage, disable_notification: Bool? = nil, protect_content: Bool? = nil, allow_paid_broadcast: Bool? = nil, message_effect_id: String? = nil, suggested_post_parameters: SuggestedPostParameters? = nil, reply_parameters: ReplyParameters? = nil, reply_markup: Either4<InlineKeyboardMarkup, ReplyKeyboardMarkup, ReplyKeyboardRemove, ForceReply>? = nil) {
            self.business_connection_id = business_connection_id
            self.chat_id = chat_id
            self.message_thread_id = message_thread_id
            self.direct_messages_topic_id = direct_messages_topic_id
...
extension TelegramAPI {
    ...
    public typealias SendRichMessageResponse = ResponseSuccess<Message>
...
extension TelegramAPI {
    ...
    public struct SendRichMessageDraftParams: Codable {
        /** Integer | Unique identifier for the target private chat */
        public let chat_id: Int
        /** Integer | Unique identifier for the target message thread */
        public let message_thread_id: Int?
        /** Integer | Unique identifier of the message draft; must be non-zero. Changes to drafts with the same identifier are animated. */
        public let draft_id: Int
        /** InputRichMessage | The partial message to be streamed */
        public let rich_message: InputRichMessage
        
        public init(chat_id: Int, message_thread_id: Int? = nil, draft_id: Int, rich_message: InputRichMessage) {
            self.chat_id = chat_id
            self.message_thread_id = message_thread_id
            self.draft_id = draft_id
            self.rich_message = rich_message
...
extension TelegramAPI {
    ...
    public typealias SendRichMessageDraftResponse = ResponseSuccess<Bool>
